...
public class Ejercicios4 extends AppCompatActivity {
    Random r = new Random();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lawea = findViewById(R.id.layoutejercicios4);
        tvtitulo = findViewById(R.id.tituloejercicios6);
        tvejercicio = findViewById(R.id.ejericiotexto6);
        respuesta = findViewById(R.id.respuestaejercicio6);
        RG1 = findViewById(R.id.radioGroupres6);
        rba = findViewById(R.id.respuestaA6);
        rbb = findViewById(R.id.respuestaB6);
        rbc = findViewById(R.id.respuestaC6);
        rbd = findViewById(R.id.respuestaD6);
        imgejercicio = findViewById(R.id.imagendeejercicio6);
        btr1 = findViewById(R.id.bottonres16);
        btr2 = findViewById(R.id.bottonres26);
